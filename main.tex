...
\titulo{Modelagem cinemática da refração sísmica pela equação eikonal: um estudo comparativo de precisão e performance}
\TituloEmIngles{Cinematic refraction seismic modeling via eikonal equation: a comparative study of accuracy and performance}
