...
\titulo{Efeitos da imprecisão do núcleo de modelagem sísmica via equação eikonal na tomografia de refração 3D}
\TituloEmIngles{Seismic modeling kernel via eikonal equation inaccuracy effects in 3D first arrival tomography}
