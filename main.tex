...
\titulo{Efeitos da imprecisão do núcleo de modelagem na tomografia de refração}
\TituloEmIngles{Effects of modeling kernel inaccuracy in refraction tomography}
