...
\begin{equation}
	F = |(B / A)\times(B - A)|,
\end{equation} 
\noindent sendo $F$ a indicação de existência de primeiras chegadas no dado. \citeonline{qin2021first} adiciona novos termos para se obter indicações de primeiras chegadas mais precisas formulando a equação
\begin{equation}
