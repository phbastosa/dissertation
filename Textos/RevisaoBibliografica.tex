...
Considerando a utilização de dados sintéticos, a formulação aplicada neste trabalho é analítica baseada no somatório da energia do dado em janelas de percorrimento temporal. \citeonline{pan2019automatic} calculam dois parâmetros relacionados com o traço sísmico 
\begin{equation}
